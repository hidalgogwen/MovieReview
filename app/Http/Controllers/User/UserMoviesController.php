...
class UserMoviesController extends Controller
{
    ...
    {
    	$movie = Movie::all();
        return view('user.movies.index',compact('movie'));
    }
    ...
    public function view($movie_id)
    {
        ...
        return view('user.movies.view', compact('movie','avgRate'));
    }
            ...
            '<div class="col-3" style="padding-bottom: 10px; padding-top: 10px;">
                    <div class="card" style="width: 18rem;text-align: center; ">
                        ...
                        <div class="card-body">
                            ...
                            <a href="'.url('user/view-movie/'.$movie->id).'" class="btn btn-" style="background-color:#192841; color: #fff;">View Details</a>
                        </div>
                    </div>
                </div>';
        }
