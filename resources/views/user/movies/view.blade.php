		...
		<div class="justify-content-center">
			<div class="container-fluid" style="padding-top: 20px; padding-bottom: 20px">
				<div class="card" style="width: 50rem; padding: 10px;">
					...
					<div class="card card-body shadow-sm mt-1">
						<p class="card-text">
					...
					<div class="review-area mt-3">
						...
						@if (count($movie->review))
							...
							@endforeach
						@else
							<p style="padding-left:20px;">No reviews!</p>
						@endif
						
						<div class="card card-body shadow-sm mt-3">
							<h6 class="card-title">Leave a review</h6>
							<form action="{{ route('view-movie.review.store', $movie->id) }}" method="POST">
								@csrf

								<input type="number" min="1" max="10" name="rate" class="form-control" placeholder="Rating" style="width: 20%;">
								<input type="text" name="comment_body" class="form-control mt-3" placeholder="Say something..." style="height: 100px;">
								<button type="submit" class="btn btn-danger mt-3">Submit</button>

								<a href="{{ url('/user/all-movies') }}" class="btn mt-3" style="background-color:#192841; color: #fff; float: right;">Go back</a>
							</form>
						</div>
					</div>
				</div>
